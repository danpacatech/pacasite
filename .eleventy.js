module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy({ "src/pgb.html": "pgb/index.html" });

  // Hidden tool pages: copied through verbatim, never rendered as templates
  // and never listed in the sitemap.
  ["ppb", "plb", "tix", "pgb"].forEach(function (tool) {
    eleventyConfig.ignores.add("src/" + tool + ".html");
  });
